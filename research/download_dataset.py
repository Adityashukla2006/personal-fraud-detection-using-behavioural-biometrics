...
``research/data/raw/`` and proves it arrived intact before anything downstream is allowed to use it.
...
DESTINATION = REPO_ROOT / "research" / "data" / "raw" / "DSL-StrongPasswordData.csv"
